...
set body='I collected {readings} BP readings over the last {days} days, and my blood pressure is still above goal; my BP average is {systolic}/{diastolic}.  I am currently taking {meds}.  What steps would you like me to take next?',
...
update contact_message
set body='I experienced a side effect recently, I believe due to blood pressure management.  To safely manage my blood pressure at home, what steps would you like me to take next?',
