            ...
            function _authorize() {
                _authorize = (0, _asyncToGenerator2.default)(
                    ...
                    _regenerator.default.mark(function _callee(env, params, _noRedirect) {
                        var _params, iss, launch, fhirServiceUrl, redirect_uri, redirectUri, _params$scope, scope,
                            clientSecret, fakeTokenResponse, patientId, encounterId, client_id, clientId, url, storage,
                            serverUrl, stateKey, state, redirectUrl, extensions, redirectParams;
            ...
            function _completeAuth() {
                _completeAuth = (0, _asyncToGenerator2.default)(
                    ...
                    _regenerator.default.mark(function _callee2(env) {
                        var url, Storage, params, key, code, authError, authErrorDescription, msg, state,
                            fullSessionStorageSupport, hasState, authorized, requestOptions, tokenResponse, client;
                        return _regenerator.default.wrap(function _callee2$(_context2) {
                            while (1) {
                                switch (_context2.prev = _context2.next) {
                                    case 0:
