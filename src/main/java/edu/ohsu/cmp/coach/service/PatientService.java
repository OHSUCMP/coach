...
public class PatientService extends AbstractService {
    ...
    public PatientModel buildPatient(String sessionId) throws DataException, ConfigurationException, IOException {
    ...
    public MyPatient getMyPatient(String fhirPatientId) {
        ...
        if (repository.existsPatientByPatIdHash(patIdHash)) {
            ...
            auditService.doAudit(p, AuditSeverity.INFO, "created patient record");
        }
